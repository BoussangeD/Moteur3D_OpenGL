...
#include "lab_work_projet/lab_work_projet.hpp"
...
namespace M3D_ISICG
{
	...
	void LabWorkManager::drawMenu()
	{
		...
		//if ( ImGui ::MenuItem( "Lab work Projet" ) )
		//{
		//	if ( _type != TYPE ::LAB_WORK_PROJET ) // Change only if needed .
		//	{
		//		// Keep window size .
		//		const int w = _current->getWindowWidth();
		//		const int h = _current->getWindowHeight();
		//		delete _current;			  // Delete old lab work .
		//		_current = new LabWorkProjet();	  // Create new lab work .
		//		_type	 = TYPE ::LAB_WORK_PROJET; // Update type .
		//		_current->resize( w, h );	  // Update window size .
		//		_current->init();			  // Don ’t forget to call init ().
		//	}
		//}
